...
│   ├── calibrate.py     # выбор порогов (f1/blend/prior/nested)
...
F1 0.600->0.667) и предметы (AUC 0.753->0.856, F1 0.500->0.625). Укладка бедра
